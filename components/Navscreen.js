        ...
        <Center minH="100vh" position="fixed" w="100vw" bg={navclr}>
            <Box justify="center" mb="200px">
                <VStack>
                    ...
                    <Linkpage page={"/lesson"} name={"Bible Study"} color={sbtn} menu={props.menu} setMenu={props.setMenu}></Linkpage>
                    <Linkpage page={"/ministry"} name={"Ministry"} color={sbtn} menu={props.menu} setMenu={props.setMenu}></Linkpage>
                    <Linkpage page={"/counselling"} name={"Counselling"} color={sbtn} menu={props.menu} setMenu={props.setMenu}></Linkpage>
                    <Linkpage page={"/contact"} name={"Contact"} color={sbtn} menu={props.menu} setMenu={props.setMenu}></Linkpage>
                </VStack>
            </Box>
        </Center>
    )
