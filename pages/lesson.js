import { Heading, useColorMode, useColorModeValue, HStack, Center } from '@chakra-ui/react';
			...
			<>
				...
				<HStack overflowX="scroll" spacing="24px" py={8} mb={12}>
					{props.lessons.map((lesson, id) => (
						<a key={id} href={'article?lesson=' + lesson.slug} onClick={() => lessonClick(lesson.slug + '_is_clicked')}>
							<Boximage
								id={id}
								link={lesson.slug}
