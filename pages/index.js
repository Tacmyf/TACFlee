import { Button, Heading, useColorMode, useColorModeValue, Image, VStack, Text, Box, Center, Container, Flex } from "@chakra-ui/core"
        ...
        <Layout>
            <Center mt={[0, 0, 14, 16]}>
                <Box display={{ base: "block", sm: "block", md: "block", lg: "flex" }} alignItems="center">
                    <Box>
                        <Heading fontWeight="black" textAlign={["center", "center", "center", "left"]} fontSize={["4xl", "4xl", "5xl", "6xl"]} mt={10} color={sbtn}>
                            Tamil Annual Conference<br />Methodist Youth Fellowship
                        </Heading>
                        <Flex pt={12} justify={["center", "center", "center", "left", ]}>
                            <Link href="/lesson">
                                <Box fontFamily="Poppins" cursor="pointer" fontWeight="bold" fontSize="2xl" w={["55%", "35%", "25%", "20%"]} _hover={{ bg: btn }} bg={btn} color="#F8F8F8" size="lg" rounded={25} pt={1} pb={1}>
                                    <Center>
                                        <Text>Flee</Text>
                                    </Center>
                                </Box>
